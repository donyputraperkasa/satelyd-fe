...
export function RegisterModal({
  ...
  return (
    <BaseModal isOpen={isOpen} onClose={onClose}>
      ...
      {errorMsg && (
        <div className="mb-4 rounded-lg bg-[#FBEAEB] border border-[#F2C2C6] p-3 text-xs text-[#8A1F2D]">{errorMsg}</div>
      )}
      ...
      <div className="mt-5 flex flex-col items-center gap-2 border-t border-[#E5D7DC] pt-3.5 text-xs text-[#7A5661]">
        <p>
          Sudah memiliki akun?{" "}
